...
class GHworkerGraphics:
    ...
    def update(self, newState):
        ...
        if newState._foodEaten != None:
            self.removeFood(newState, newState._foodEaten, self.food)
...
class FirstPersonGHworkerGraphics(GHworkerGraphics):
    def __init__(self, zoom = 1.0, showGhosts = True, capture = False, frameTime=0):
        GHworkerGraphics.__init__(self, zoom, frameTime=frameTime)
    ...
    def initialize(self, state, isBlue = False):
        ...
        self.isBlue = isBlue
        GHworkerGraphics.startGraphics(self, state)
    ...
    def getPosition(self, ghostState):
        if not self.showGhosts and not ghostState.isPacman and ghostState.getPosition()[1] > 1:
            ...
            return GHworkerGraphics.getPosition(self, ghostState)
